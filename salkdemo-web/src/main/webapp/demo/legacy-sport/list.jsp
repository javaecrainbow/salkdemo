...
<tbody>
	<tr>
    <td><c:out value="11111111 "/></td>
    <td><c:out value="T-shirt"/></td>
    <td>
       2015-08-25
...
<c:forEach var="export" items="${exports}">
	...
	<tr>
    <td><c:out value="${export.exportNo} "/></td>
    <td><c:out value="${export.exportType} "/></td>
    <td>
        <fmt:formatDate value="${export.exportDate}" type="date" pattern="yyyy-MM-dd"/>
        
    </td>
    <td>
        <c:out value="${export.exportColor} "/>
    </td>
      <td>
	<c:out value="${export.exportSize} "/>
    </td>
     <td>
                                <div class='text-right'>
                                    <a class='btn btn-success btn-mini' href='#'>
